...
engine = create_engine("mysql://root:ok123@localhost/allSharesTickNear90?charset=utf8")
...
for checkOne in dfCheckExist['Tables_in_allSharesTickNear90']:
...
for i in selectedCode:
    ...
    #print mdf
    mdf.to_sql('ticknt' + code,connection,if_exists = 'replace',chunksize = 1000)
